...
ggsave('../mlhc-submission-files/figs/intervals.png', height = 5, width = 8)
...
compare_mcmc_map = d %>% 
  ...
  scale_y_log10()+
  theme(aspect.ratio = 1)+
  labs(x='HMC Predicted\nLog Concentration (ng/ml)', y='MAP Predicted\nlog(Concentration)')
...
figure = true_v_pred + compare_mcmc_map

figure
ggsave('../mlhc-submission-files/figs/compare.png', plot = figure, height = 3)
```
